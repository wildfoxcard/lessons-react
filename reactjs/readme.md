...
This video is about request only one post
...
This video is about attaching the post request into an onclick handler.
...
This video is about more complex state objects being managed by "useReducor"
...
Note: spread operator for maintaining state.

#### 64th video

This video is about multiple useReducers

This is much better than example above for duplicated functionality.
...
This video is about using useEffect, useReducer, and axios together.
...
This video is another design for custom hook
